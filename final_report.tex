...
% affiliations
\author{\IEEEauthorblockN{Christine Baek}
\IEEEauthorblockA{Computational Biology\\
Carnegie Mellon University\\
baek@cmu.edu}
\and
\IEEEauthorblockN{Qi Chu}
\IEEEauthorblockA{Computational Biology\\
Carnegie Mellon University\\
qchu@andrew.cmu.edu}
\and
\IEEEauthorblockN{Yanyu Liang}
\IEEEauthorblockA{Computational Biology\\
Carnegie Mellon University\\
...
\item  A profile HMM is built on the multiple sequence alignment for each domain by Hmmer (http://hmmer.org/).
\item Search for matches using the profile HMM in the sequences of all previously downloaded \textit{Cas} family proteins.
\end{enumerate}

\subsubsection{Analysis}\\
For method testing, a set of globin sequences given in Hmmer is used. Since there are \textit{Cas9} and \textit{Cas5} in the previously downloaded \textit{Cas} family proteins sequences, they also act as positive control since the method should be able to find the domains in these proteins.\\
