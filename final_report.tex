...
The optimization curves of motif finding in \textit{Cas5} and \textit{Cas7} with width 10, 50, 110 are shown in \Cref{fig:cas5} and \Cref{fig:cas7}. From the curves we can see the Markov chain almost converges in each run.
\begin{figure}[htbp]
  \centering
  \begin{minipage}{0.32\textwidth}
    \centering
